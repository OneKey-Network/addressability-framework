...
-   The actual open-source code for MVP implementation is hosted in another GitHub repo that is here: [PAF-implementation](https://github.com/prebid/paf-mvp-implementation)
