...
The domain name of the receiver of this response (the website)
...
Contains an empty list of identifiers and undefined preferences for delete-ids-prefs-response
...
Sent if code is different from `204`
