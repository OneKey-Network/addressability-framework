...
A Seed is data generated by the publisher gathering the identity of the publisher, and Transaction Id - one per ad slot. 

### Transmission Requests

A Transmission Request is always sent aside from PAF Data. It is associated with
...
Workflow including "parent" Transmission Requests and "children" Transmission Responses:
