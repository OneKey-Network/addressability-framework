...
Two types of data is manipulated by the operator API: identifiers and preferences.
...
Detailed format available in [identifier.md](messages/identifier.md)
...
The list of identifiers is stored as a cookie named `paf_ids`

#### Preferences
Preferences are user-set preferences regarding online tracking that is captured by a CMP UI or a website (such as a publisher).
- There can be multiple preferences objects, but for the MVP **a single boolean** will be stored.


Detailed format available in [preferences.md](messages/preferences.md)
...
The preferences are stored as a cookie named `paf_preferences`
...
Detailed format available in [source.md](messages/source.md)
...
Detailed format available in [get-id-prefs-request.md](messages/get-id-prefs-request.md)
...
DetailedDetailed format available in [get-id-prefs-response.md](messages/get-id-prefs-response.md)
...
DetailedIn this case and to avoid an extra call to the API, a **newly generated ID** is returned.
...
Detailed format available in [get-id-prefs-response.md](messages/get-id-prefs-response.md)
...
Detailed format available in [post-id-prefs-request.md](messages/post-id-prefs-request.md)
...
Detailed format available in [post-id-prefs-response.md](messages/post-id-prefs-response.md)

Example:

Detailed<!--partial-begin { "files": [ "paf-mvp-demo-express/src/examples/generated-examples/postIdPrefsResponse.json" ], "block": "json" } -->
<!-- ⚠️ GENERATED CONTENT - DO NOT MODIFY DIRECTLY ⚠️ -->
```json
{
  "body": {
...
Detailed format available in [get-new-id-request.md](messages/get-new-id-request.md)
...
Detailed format available in [get-new-id-response.md](messages/get-new-id-response.md)
