...
all parties that participate to one or many Addressable Content have all the necessary
**Transmission Results** for auditing a given Addressable Content. 
...
It gathers the identity of the publisher, a **Transaction Id** and a list of **Addressable Content Id**. 
...
**Transaction Id** of its **Seed** and the **Addressable Content Id** of the Addressable Content
that the Receiver is willing to participate.
